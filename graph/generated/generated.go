...
func (ec *executionContext) field_Mutation_createCustomer_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		...
		arg0, err = ec.unmarshalNNewCustomer2githubᚗcomᚋafrizal423ᚋgoᚑsupermarketᚑgpqlᚋgraphᚋmodelᚐNewCustomer(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Mutation_createCustomer(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.(*model.Customer)
	fc.Result = res
	return ec.marshalNCustomer2ᚖgithubᚗcomᚋafrizal423ᚋgoᚑsupermarketᚑgpqlᚋgraphᚋmodelᚐCustomer(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalInputNewCustomer(ctx context.Context, obj interface{}) (model.NewCustomer, error) {
	...
	for k, v := range asMap {
		...
		case "segment":
			...
			it.Segment, err = ec.unmarshalNString2string(ctx, v)
			if err != nil {
				return it, err
			}
		case "age":
...
func (ec *executionContext) marshalNCustomer2githubᚗcomᚋafrizal423ᚋgoᚑsupermarketᚑgpqlᚋgraphᚋmodelᚐCustomer(ctx context.Context, sel ast.SelectionSet, v model.Customer) graphql.Marshaler {
...
func (ec *executionContext) unmarshalNNewCustomer2githubᚗcomᚋafrizal423ᚋgoᚑsupermarketᚑgpqlᚋgraphᚋmodelᚐNewCustomer(ctx context.Context, v interface{}) (model.NewCustomer, error) {
